      ...
      <div className="animate-fadeIn">
        <div className="text-center">
          ...
          <p className="text-gray-500 mb-6">
            If an account exists with that email, we've sent a 6-digit verification code to reset your password. The code expires in 1 hour.
          </p>
          <Link
            to={`/reset-password?email=${encodeURIComponent(watch('email'))}`}
