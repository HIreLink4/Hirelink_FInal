  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const msg =
        ...
        'Failed to reset password. The code may be expired or incorrect.'
      setError(msg)
    } finally {
      setIsLoading(false)
    }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2">Enter your verification code and new password.</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`input pl-12 tracking-widest text-lg ${errors.otp ? 'input-error' : ''}`}
                placeholder="000000"
              />
            </div>
            {errors.otp && (
