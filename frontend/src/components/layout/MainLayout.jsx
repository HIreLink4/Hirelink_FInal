                  ...
                  >
                    {user?.profileImageUrl ? (
                      <>
                        ...
                        />
                        <div className="w-8 h-8 bg-primary-100 rounded-full items-center justify-center hidden">
                  ...
                  >
                    {user?.profileImageUrl ? (
                      <>
                        ...
                        />
                        <UserCircleIcon className="h-5 w-5 hidden" />
                      </>
                    ) : (
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-primary-200 text-sm">
                ...
                {!isAdmin && <li><Link to="/bookings" className="hover:text-white transition-colors">My Bookings</Link></li>}
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-primary-200 text-sm">
                ...
                <li>1800-XXX-XXXX</li>
                <li className="pt-2 text-xs">All credits reserved to HireLink</li>
              </ul>
            </div>
          </div>
