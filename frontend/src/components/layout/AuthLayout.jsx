    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-primary-100 flex flex-col">
      <header className="p-6">
        <Link to="/" className="flex items-center space-x-2 w-fit">
          <div className="w-10 h-10 bg-gradient-to-br from-primary-500 to-primary-700 shadow-primary-500/30 rounded-xl flex items-center justify-center shadow-lg">
      ...
      <main className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <div className="mt-8 text-center text-gray-500 text-sm">
            <p>All credits reserved to HireLink 2026</p>
          </div>
        </div>
      </main>
