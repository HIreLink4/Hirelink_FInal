...
public class PaymentService {
    ...
    public PaymentDTO.CreateOrderResponse createOrder(Long userId, Long bookingId) {
        ...
        // Change: Charge only the platform fee (bookingCharge) through the system.
        // The serviceFee is paid directly to the provider.
        BigDecimal totalAmount = bookingCharge;
